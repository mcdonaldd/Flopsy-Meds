      ...
      <div className="auth-screen">
        <div className="auth-card card">
          <div className="card__face stack-md">
            ...
            <p className="body-md">
              Check your inbox &mdash; we sent a confirmation link to <strong>{confirming}</strong>. Click it to finish creating your account, then come back and sign in.
            </p>
            <button
              type="button"
    ...
    <div className="auth-screen">
      <div className="auth-card card">
        <div className="card__face stack-md">
          ...
          <p className="body-md">
            {mode === 'login'
              ? 'Sign in to see the daily checklist.'
              : "Create an account — it starts pre-loaded with Flopsy’s discharge meds."}
          </p>
